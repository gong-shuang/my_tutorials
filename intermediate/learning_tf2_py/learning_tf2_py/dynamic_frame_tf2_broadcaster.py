...
class DynamicFrameBroadcaster(Node):
    ...
    def broadcast_timer_callback(self):
        ...
        # 设置平移分量（位置）
        # 做圆周运动：x 坐标为 10*sin(t)，y 坐标为 10*cos(t)
        t.transform.translation.x = 10 * math.sin(x)  # X 坐标（随时间变化）
        t.transform.translation.y = 10 * math.cos(x)  # Y 坐标（随时间变化）
