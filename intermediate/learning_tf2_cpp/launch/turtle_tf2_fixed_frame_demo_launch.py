...
def generate_launch_description():
    """
    生成固定坐标系 TF2 演示的 launch 描述

    该 launch 文件在基础 TF2 演示的基础上，增加了一个固定坐标系广播器。
    固定坐标系广播器会创建一个名为 'carrot1' 的坐标系，该坐标系相对于 world 坐标系的位置是固定的。
    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                executable="fixed_frame_tf2_broadcaster",  # 可执行文件（固定坐标系广播器）
